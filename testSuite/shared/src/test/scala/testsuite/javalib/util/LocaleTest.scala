...
object LocaleTest extends TestSuite with LocaleTestSetup {
  ...
  val tests = Tests {
    ...
    'test_default_SIMPLIFIED_CHINESE - {
    ...
    'test_default_locale_per_category - {
    ...
    'test_for_language_tag_special_cases - {
    ...
    'test_for_language_tag_grandfathereded - {
