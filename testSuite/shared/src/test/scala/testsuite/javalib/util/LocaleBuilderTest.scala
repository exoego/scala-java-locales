...
object LocaleBuilderTest extends TestSuite with LocaleTestSetup {
  val tests = Tests {
    'test_build_with_language - {
    ...
    'test_build_language_canonicalization - {
      val b1 = new Locale.Builder()
    ...
    'test_build_script_canonicalization - {
      val b1 = new Locale.Builder()
      val locale = b1.setScript("cyrl").build
      assertEquals("Cyrl", locale.getScript)
    }

    'test_build_with_region - {
      val b1 = new Locale.Builder()
    ...
    'test_extensions_canonalization - {
      val b1 = new Locale.Builder()
      val locale = b1.setExtension('a', "Ca-Japanese").build
      assertEquals("ca-japanese", locale.getExtension('a'))
    }

    'test_build_with_unicode_extensions - {
      val b1 = new Locale.Builder()
      val locale = b1
    ...
    'test_replace_unicode_extensions - {
      val b1 = new Locale.Builder()
      val locale1 = b1
        .setUnicodeLocaleKeyword("nu", "thai")
        .setUnicodeLocaleKeyword("ok", "")
    ...
    'test_build_with_unicode_attributes - {
      val b1 = new Locale.Builder()
