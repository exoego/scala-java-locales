...
object DateFormatTest extends TestSuite with LocaleTestSetup {
  ...
  val stdLocales = List(
    TestCase(
      ...
      Locale.ENGLISH,
      cldr21 = false,
      Map(DateFormat.FULL -> "EEEE, MMMM d, y",
          DateFormat.LONG -> "MMMM d, y",
          DateFormat.MEDIUM -> "MMM d, y",
          DateFormat.SHORT -> "M/d/yy"),
      Map(DateFormat.FULL -> "h:mm:ss a zzzz",
  ...
  val stdLocalesDiff = List(
    TestCase(
      ...
      Map(DateFormat.FULL -> "HH:mm:ss zzzz",
    ...
    TestCase(
      ...
      Locale.GERMAN,
      cldr21 = true,
      Map(DateFormat.FULL -> "EEEE, d. MMMM y",
          DateFormat.LONG -> "d. MMMM y",
    ...
    TestCase(
      ...
      Locale.JAPANESE,
      cldr21 = true,
      Map(DateFormat.FULL -> "y年M月d日EEEE",
          DateFormat.LONG -> "y年M月d日",
          DateFormat.MEDIUM -> "yyyy/MM/dd",
          DateFormat.SHORT -> "yyyy/MM/dd"),
      Map(DateFormat.FULL -> "H時mm分ss秒 zzzz",
    ...
    TestCase(
      ...
      Map(DateFormat.FULL -> "y年M月d日EEEE",
          ...
          DateFormat.MEDIUM -> "yyyy-M-d",
          DateFormat.SHORT -> "yy-M-d"),
      Map(DateFormat.FULL -> "zzzzah时mm分ss秒",
    ...
    TestCase(
      ...
      Map(DateFormat.FULL -> "zzzz ah:mm:ss",
    ...
    TestCase(
      ...
      Map(DateFormat.FULL -> "y年M月d日EEEE",
          ...
          DateFormat.MEDIUM -> "yyyy/M/d",
          DateFormat.SHORT -> "y/M/d"),
      Map(DateFormat.FULL -> "zzzzah時mm分ss秒",
    ...
    TestCase(
      ...
      Locale.TRADITIONAL_CHINESE,
      cldr21 = false,
      Map(DateFormat.FULL -> "y年M月d日 EEEE",
          DateFormat.LONG -> "y年M月d日",
          DateFormat.MEDIUM -> "y年M月d日",
          DateFormat.SHORT -> "y/M/d"),
      Map(DateFormat.FULL -> "ah:mm:ss [zzzz]",
    ...
    TestCase(
      ...
      Map( // JVM
          ...
          DateFormat.MEDIUM -> "yyyy-MM-dd",
          DateFormat.SHORT -> "yy-MM-dd"),
      Map(DateFormat.FULL -> "HH 'h' mm 'min' ss 's' zzzz",
          DateFormat.LONG -> "HH:mm:ss z",
          DateFormat.MEDIUM -> "HH:mm:ss",
          DateFormat.SHORT -> "HH:mm")
    ),
  ...
  val localesByTagDiff = List(
    ...
    TestCase(
      ...
      Map( // JVM
          ...
          DateFormat.MEDIUM -> "d-MMM-y",
          DateFormat.SHORT -> "dd.MM.yy"),
      Map(DateFormat.FULL -> "HH.mm:ss 'h' zzzz",
          DateFormat.LONG -> "HH:mm:ss z",
          DateFormat.MEDIUM -> "HH:mm:ss",
          DateFormat.SHORT -> "HH:mm")
    ),
    ...
    TestCase(
      ...
      Map(DateFormat.FULL -> "zzzz h:mm:ss a",
    ...
    TestCase(
      ...
      Map(DateFormat.FULL -> "H:mm:ss (zzzz)",
          DateFormat.LONG -> "H:mm:ss (z)",
          DateFormat.MEDIUM -> "H:mm:ss",
          DateFormat.SHORT -> "H:mm")
    ),
    ...
    TestCase(
      ...
      Map( // JS
          ...
          DateFormat.MEDIUM -> "y၊ MMM d",
          DateFormat.SHORT -> "dd-MM-yy"),
      Map(DateFormat.FULL -> "zzzz HH:mm:ss",
